            ...
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'flex-start' }}>
                ...
                <div style={{
                    ...
                    <div style={cardStyle}>
                        ...
                        <p>MedIntification es un software de identificación de inventario mediante imágenes, utilizando inteligencia artificial</p>
                        <Link to="/proyecto4/informacion" style={{ color: '#007BFF', textDecoration: 'none' }}>
                            Ver más
                        </Link>
                    </div>
                    ...
                    <div style={cardStyle}>
                        ...
                        <p>desarrollar soluciones que permitan optimizar procesos quirúrgicos, mejorando su precisión y eficiencia.</p>
                        <Link to="/proyecto4/sobre-nosotros" style={{ color: '#007BFF', textDecoration: 'none' }}>
                            Ver más
                        </Link>
                    </div>
