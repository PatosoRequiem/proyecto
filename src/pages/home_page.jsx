  ...
  return (
    <div className='layout__page'>
      ...
      <h2>
        ...
        <div className="singleLineImageContainer">
          <div className="containerElement">
            <img src={Thumbnail} alt='thumbnail' style={{ cursor: 'pointer' }} onClick={() => navigate("/proyecto11")}/>
            <p className="text" ><Checkbox style={{color:'white'}}/>MarIAna</p>
            <p className="text" >por Swal</p>
          </div>
          <div className="containerElement">
            <img src={Thumbnail} alt='thumbnail' style={{ cursor: 'pointer' }} onClick={() => navigate("/proyecto12")}/>
            <p className="text" ><Checkbox style={{color:'white'}}/>GerioTracker</p>
            <p className="text" >por Myosotis</p>
          </div>
          <div className="containerElement">
            <img src={Thumbnail} alt='thumbnail' style={{ cursor: 'pointer' }} onClick={() => navigate("/proyecto13")}/>
            <p className="text" ><Checkbox style={{color:'white'}}/>QAGuardIAn</p>
            <p className="text" >por PanDev</p>
          </div>
          <div className="containerElement">
            <img src={Thumbnail} alt='thumbnail' style={{ cursor: 'pointer' }} onClick={() => navigate("/proyecto14")}/>
            <p className="text" ><Checkbox style={{color:'white'}}/>IATU</p>
            <p className="text" >por Usability AI Solutions</p>
          </div>
          <div className="containerElement">
            <img src={Thumbnail} alt='thumbnail' style={{ cursor: 'pointer' }} onClick={() => navigate("/proyecto15")}/>
            <p className="text" ><Checkbox style={{color:'white'}}/>CanarIA</p>
            <p className="text" >por AviSoft</p>
          </div>
          <div className="containerElement">
            <img src={Thumbnail} alt='thumbnail' style={{ cursor: 'pointer' }} onClick={() => navigate("/proyecto16")}/>
            <p className="text" ><Checkbox style={{color:'white'}}/>MineGuard</p>
            <p className="text" >por AridDewellers</p>
          </div>
          <div className="containerElement">
            <img src={Thumbnail} alt='thumbnail' style={{ cursor: 'pointer' }} onClick={() => navigate("/proyecto17")}/>
            <p className="text" ><Checkbox style={{color:'white'}}/>GeoTMM</p>
            <p className="text" >por Futuring</p>
          </div>
          <div className="containerElement">
            <img src={Thumbnail} alt='thumbnail' style={{ cursor: 'pointer' }} onClick={() => navigate("/proyecto18")}/>
            <p className="text" ><Checkbox style={{color:'white'}}/>AgroPred</p>
            <p className="text" >por AgroPred</p>
          </div>
          <div className="containerElement">
            <img src={Thumbnail} alt='thumbnail' style={{ cursor: 'pointer' }} onClick={() => navigate("/proyecto19")}/>
            <p className="text" ><Checkbox style={{color:'white'}}/>AuditForge</p>
            <p className="text" >por DevForge</p>
          </div>
          <div className="containerElement">
            <img src={Thumbnail} alt='thumbnail' style={{ cursor: 'pointer' }} onClick={() => navigate("/proyecto20")}/>
